Check that branching works:
  ...
  ono: [ERROR] owi error: create temporary file config/bos-8e79d6.tmp: No such file or directory
  [123]
  ...
  ono: [ERROR] owi error: create temporary file config/bos-cf319e.tmp: No such file or directory
  [123]
