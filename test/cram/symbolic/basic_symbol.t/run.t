Check that branching works:
  ...
  ono: [ERROR] owi error: create temporary file config/bos-24da0f.tmp: No such file or directory
  [123]
  ...
  ono: [ERROR] owi error: create temporary file config/bos-3beded.tmp: No such file or directory
  [123]
